...
async def run_async_response(user_query: str, response_container: Any, time_container: Any):
    """Run the async response generator and update the UI"""
...
def main():
    ...
    if user_query:
        ...
        asyncio.run(run_async_response(user_query, response_container, time_container))
